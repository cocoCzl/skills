...
组合报告默认采用“经理人详版”，除非用户明确要求简短输出。四串一或串关报告应先给总方案，再给北京时间四场赛程确认、比赛大纲 / 今日赛程确认、小组排名/积分/战意、数据来源总览、赔率与市场中心、模型怎么来的和逐场分析。每场分析至少包含数据依据、小组/战意、基础面自然语言分析、比赛剧本、数学模型、胜平负概率、让球判断、大小球判断、比分分布、等级和风险；之后再给胜平负与大小球汇总、比分覆盖建议、四串一参考购买方案、已有购买方案评价、组合相关性检查、更多组合候选，以及 Pass 或排除项说明。
