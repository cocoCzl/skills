...
- Default market priority: 胜平负 / 让球胜平负 > 大小球 / 总进球 > 比分 > 半全场.
...
- 半全场 is supported as a formal high-variance market only when `half_time_full_time` odds are verified. Without verified HAFU odds, output only probability lean and do not create Value Judgment or purchase-plan legs.
